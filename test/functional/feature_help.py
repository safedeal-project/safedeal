...
"""Verify that starting safedeal with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start safedeal with -? for help text")
        ...
        self.log.info("Start safedeal with -version for version information")

...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected SFD supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check SFD supply at the beginning
        # ------------------------------------------
        # SFD supply: block rewards minus burned fees for minting
        ...
        # Verify that SFD supplies were properly updated after the spends and reorgs
        self.log.info("Check SFD supply...")

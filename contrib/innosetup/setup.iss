...
#define MyAppName "SafeDeal Core"
#define MyAppPublisher "2022 SafeDeal Core Developers"
#define MyAppURL "https://safedeal.trade/"
#define MyAppExeName "safedeal-qt.exe"
#define MyAppExtraData "https://safedeal.trade/downloads/bootstrap.zip"
...
DefaultDirName={autopf}\SafeDeal
...
OutputDir=.\output
OutputBaseFilename=SafeDealSetup
...
DefaultGroupName=SafeDeal Core
...
[Files]
Source: ".\package\safedeal-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\SafeDeal\SafeDeal-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\SafeDeal\SafeDeal-Qt,strDataDir|{userappdata}\SafeDeal\}');
  Result := True;
end;

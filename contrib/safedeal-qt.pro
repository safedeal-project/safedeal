...
RESOURCES += src/qt/safedeal.qrc src/qt/safedeal_locale.qrc

TRANSLATIONS += src/qt/locale/safedeal_bg.ts \
                src/qt/locale/safedeal_de.ts \
                src/qt/locale/safedeal_en.ts \
                src/qt/locale/safedeal_es.ts \
                src/qt/locale/safedeal_fi.ts \
                src/qt/locale/safedeal_fr.ts \
                src/qt/locale/safedeal_it.ts \
                src/qt/locale/safedeal_ja.ts \
                src/qt/locale/safedeal_pl.ts \
                src/qt/locale/safedeal_pt.ts \
                src/qt/locale/safedeal_ru.ts \
                src/qt/locale/safedeal_sk.ts \
                src/qt/locale/safedeal_sv.ts \
                src/qt/locale/safedeal_vi.ts \
                src/qt/locale/safedeal_zh_CN.ts \
                src/qt/locale/safedeal_zh_TW.ts

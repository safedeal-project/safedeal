...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SafeDeal safedeal-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  safedeal-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded safedeal transaction") + "\n" +
                               "  safedeal-tx [options] -create [commands]   " + _("Create hex-encoded safedeal transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded safedeal transaction

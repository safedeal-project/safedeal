...
/** Utility functions used by the SafeDeal Qt UI.
 */
namespace GUIUtil
{
...
// Render SafeDeal addresses in monospace font
...
// Parse "safedeal:" URI into recipient object, return true on successful parsing

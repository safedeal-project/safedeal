...
#include "qt/safedeal/sendcustomfeedialog.h"
#include "qt/safedeal/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(SafeDealGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &SafeDealGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);

...
#ifndef SafeDeal_CORE_NEW_GUI_SafeDealGUI_H
#define SafeDeal_CORE_NEW_GUI_SafeDealGUI_H
...
#include "qt/safedeal/navmenuwidget.h"
#include "qt/safedeal/topbar.h"
#include "qt/safedeal/dashboardwidget.h"
#include "qt/safedeal/send.h"
#include "qt/safedeal/receivewidget.h"
#include "qt/safedeal/addresseswidget.h"
#include "qt/safedeal/coldstakingwidget.h"
#include "qt/safedeal/masternodeswidget.h"
#include "qt/safedeal/snackbar.h"
#include "qt/safedeal/settings/settingswidget.h"
...
/**
  SafeDeal GUI main class. This class represents the main window of the SafeDeal UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SafeDealGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SafeDealGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~SafeDealGUI();
...
#endif //SafeDeal_CORE_NEW_GUI_SafeDealGUI_H

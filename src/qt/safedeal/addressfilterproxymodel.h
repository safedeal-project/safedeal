...
#ifndef SafeDeal_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define SafeDeal_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //SafeDeal_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H

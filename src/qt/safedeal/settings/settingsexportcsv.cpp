...
#include "qt/safedeal/settings/settingsexportcsv.h"
#include "qt/safedeal/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(SafeDealGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("SafeDeal_tx_csv_export(*.csv)") : tr("SafeDeal_addresses_csv_export(*.csv)"),
                                        nullptr);

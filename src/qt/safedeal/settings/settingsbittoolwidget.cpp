...
#include "qt/safedeal/settings/settingsbittoolwidget.h"
#include "qt/safedeal/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(SafeDealGUI* _window, QWidget *parent) :

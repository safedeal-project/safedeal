...
#include "qt/safedeal/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(SafeDealGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &SafeDealGUI::openFAQ);

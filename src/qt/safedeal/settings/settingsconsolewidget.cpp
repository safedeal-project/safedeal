...
#include "qt/safedeal/settings/settingsconsolewidget.h"
#include "qt/safedeal/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/safedeal/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(SafeDealGUI* _window, QWidget *parent) :

...
#include "qt/safedeal/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/safedeal/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(SafeDealGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableSFD,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableSFD,
    ...
    connect(ui->pushButton_UnspendableSFD, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableSFD);});
    ...
    if (parent)
        connect(parent, &SafeDealGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}

...
#include "qt/safedeal/settings/settingsmultisendwidget.h"
#include "qt/safedeal/settings/forms/ui_settingsmultisendwidget.h"
#include "qt/safedeal/settings/settingsmultisenddialog.h"
    ...
    ui(new Ui::SettingsMultisendWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("MultiSend allows you to automatically send up to 100% of your stake or masternode reward to a list of other SafeDeal Coin addresses after it matures."));

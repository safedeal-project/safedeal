...
#include "qt/safedeal/settings/settingssignmessagewidgets.h"
#include "qt/safedeal/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(SafeDealGUI* _window, QWidget *parent) :

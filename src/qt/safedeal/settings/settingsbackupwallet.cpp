...
#include "qt/safedeal/settings/settingsbackupwallet.h"
#include "qt/safedeal/settings/forms/ui_settingsbackupwallet.h"
#include <QFile>
...
#include "qt/safedeal/qtutils.h"
SettingsBackupWallet::SettingsBackupWallet(SafeDealGUI* _window, QWidget *parent) :

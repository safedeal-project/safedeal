...
#include "qt/safedeal/settings/settingswalletrepairwidget.h"
#include "qt/safedeal/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/safedeal/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(SafeDealGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to SafeDealGUI::handleRestart()

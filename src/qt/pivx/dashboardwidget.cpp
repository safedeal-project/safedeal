    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of SFD earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 SFD");
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair SFD
...
void DashboardWidget::onChartRefreshed()
{
    ...
    set0->setColor(QColor(62,78,134));
	set1->setColor(QColor(128,156,255));

...
/* SafeDeal GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "SafeDeal Coin"
#define QAPP_ORG_DOMAIN "safedeal.trade"
#define QAPP_APP_NAME_DEFAULT "SafeDeal Coin-Qt"
#define QAPP_APP_NAME_TESTNET "SafeDeal Coin-Qt-testnet"

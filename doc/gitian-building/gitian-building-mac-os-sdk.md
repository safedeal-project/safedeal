...
The script [extract-osx-sdk.sh](https://github.com/safedeal-project/safedeal/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
safedeal/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/safedeal-project/safedeal/blob/master/doc/README_osx.md) for troubleshooting tips.
